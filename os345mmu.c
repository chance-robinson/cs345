...
unsigned short int *getMemAdr(int va, int rwFlg)
{
	...
	memAccess++;							// rpt memory access
	memHits++;								// rpt pinned, hence always a hit
	...
	else	{ memPageFaults++;				// rpte undefined, page fault
			}
	...
	else	{ memPageFaults++;				// upte undefined, page fault
			}
